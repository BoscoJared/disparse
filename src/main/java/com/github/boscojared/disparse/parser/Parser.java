...
import com.github.boscojared.disparse.parser.exceptions.OptionRequiresValue;
...
public class Parser {
    ...
    private static void accept(Map<CommandFlag, Object> optionMap, CommandFlag flag, Iterator<String> iter) {
