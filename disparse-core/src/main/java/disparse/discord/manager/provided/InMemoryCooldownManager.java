...
public class InMemoryCooldownManager implements CooldownManager {
    private ConcurrentHashMap<CooldownCompositeKey<String>, Instant> cooldowns = new ConcurrentHashMap<>();
    ...
    public void cooldown(CooldownCompositeKey<String> cooldownCompositeKey) { this.cooldowns.put(cooldownCompositeKey, Instant.now()); }
